  ...
  return (
    <div className="checkout-form-container mx-auto bg-white rounded-lg px-6 max-sm:px-0">
      <div className="flex justify-between items-center mb-2">
        ...
        <Link href="/auth/sign-in" className="text-gray-500 text-sm underline">
          Log in
        </Link>
      </div>
      ...
      <form>
        ...
        <div className="mb-4 max-sm:mb-2">
          ...
          {errors.country && (
            <p className="text-red-500 text-[13px]">{errors.country.message}</p>
          )}
        </div>
        ...
        <div className="mb-4 max-sm:mb-2">
          ...
          />
          {errors?.address && (
            <p className="text-red-500 text-[13px]">{errors.address?.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          <div className="mb-4">
            <div
              className={`flex items-center border border-gray-200 px-2 rounded-lg shadow-sm ${paymentInfo.type === "RAZORPAY" ? "bg-gray-100" : ""}`}
            >
              <input
                ...
                id="razorpay"
                value="RAZORPAY"
                checked={paymentInfo.type === "RAZORPAY"}
                className="h-4 w-4 text-gray-500 border-gray-300 rounded"
                onChange={paymentInfoHandler}
              />
              <label
                htmlFor="razorpay"
                className="cursor-pointer w-full py-3 ml-2 block text-sm text-gray-900"
              >
            ...
            <div
              className={`flex items-center border border-gray-200 px-2 rounded-lg shadow-sm ${paymentInfo.type === "COD" ? "bg-gray-100" : ""}`}
            >
              <input
                {...register("paymentMethod")}
                type="radio"
        ...
        <div className="w-full h-10">
          <ButtonWithSpinner loading={loading}>Confirm Order</ButtonWithSpinner>
        </div>
      </form>
    </div>
  );
