          ...
          <CarouselItem key={index}>
            <div className="w-full h-auto !bg-bg max-sm:h-[30vh] relative">
              ...
              <div className="absolute bottom-6 left-[50%] transform translate-x-[-50%]">
                <Link href={item.url}>
                  <button className="bg-bg border-[2px] border-gray-100 py-2 px-4 text-white font-semibold transition delay-50 duration-100 ease-out hover:bg-transparent hover:text-[17px]">
                    SHOP NOW
                  </button>
                </Link>
              </div>
