    ...
    <div className='my-6 border-b border-gray-200' >
        <div className='flex justify-between'>
            <div className='flex justify-start items-center bg-gray w-max px-2 rounded-lg gap-1'>
                <div className='w-6 h-6 rounded-full bg-bgg flex justify-center items-center p-1 text-[16px] text-black font-bold'>{item.name.slice(0, 1)}</div>
                <p className='text-[14px]'>{item.name}</p>
            </div>

            <div className='flex justify-center items-center gap-2 text-[12px] text-[#333]'>
        ...
        <div>
            <p className='text-[#333] text-[14px] leading-none'>{item.message}</p>
        </div>
