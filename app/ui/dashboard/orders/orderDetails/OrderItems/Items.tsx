          ...
          items?.map((item,i)=>(
            ...
            <div className='flex gap-2'>
              <div className=''>
                ...
                <p className='text-[14px] text-gray-800'>{item.productName}</p>
                <p className='text-gray-500 text-[14px] '>color: {item.variant.color}</p>
                <p className='text-gray-500 text-[14px] '>power: {item.variant.power}</p>
                </div>
            </div>
            <div className='text-[14px] pb-1 pt-1 text-gray-600'><p>sku : {item.variant.sku}</p></div>
            <div className='text-[14px] pb-1 pt-1 text-gray-600'><p>capacity : {item.variant.capacity}</p></div>
            <div className='text-[14px] pb-1 pt-1 text-gray-600'><p>model Number: {item.variant.modelNumber}</p></div>
        ...
        <div className='py-2'>
          {
            statusHistory?.map((item, i)=>(
              ...
              <span className='text-[13px] text-gray-500'>( {formatDate(item?.createdAt)} {item?.createdAt?.toLocaleTimeString()} )</span>
              </p>
            ))
          }
        </div>
